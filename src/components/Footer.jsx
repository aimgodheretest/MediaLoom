        ...
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              <a
                href="#"
                className="text-2xl font-bold text-fuchsia-600 hover:text-fuchsia-400 transition"
              >
                Media<span className="text-white">Loom</span>
              </a>
              <p className="mt-2 text-gray-400 text-sm">
                A modern live streaming solution for creators, tutors, and
                communities <br />
                with HD video, low-latency, and <br />
